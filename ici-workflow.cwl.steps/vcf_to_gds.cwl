...
- id: vcf2gds
  ...
  scatter:
  - vcf_file
  run: vcf_to_gds.cwl.steps/vcf2gds.cwl
  out:
  - id: gds_output
  - id: config_file
  sbg:x: -92.29475402832031
  sbg:y: 187.1942138671875
- id: unique_variant_id
  ...
  - id: gds_file
    source:
    - vcf2gds/gds_output
  run: vcf_to_gds.cwl.steps/unique_variant_id.cwl
  out:
  - id: unique_variant_id_gds_per_chr
  - id: config
  sbg:x: 138
...
- id: check_gds
  ...
  scatter:
  - gds_file
  run: vcf_to_gds.cwl.steps/check_gds.cwl
  out: []
...
- VCF Processing
- CWL1.0
sbg:content_hash: a99609faaadb868a683af087316a87f20ba7c93df7e7be849bea187793f294780
sbg:contributors:
- dave
sbg:createdBy: dave
sbg:createdOn: 1620320192
sbg:expand_workflow: false
sbg:id: dave/build-instance-specific-casual-inference/vcf-to-gds/1
sbg:image_url: |-
  https://platform.sb.biodatacatalyst.nhlbi.nih.gov/ns/brood/images/dave/build-instance-specific-casual-inference/vcf-to-gds/1.png
...
- id: https://bioconductor.org/packages/devel/bioc/manuals/GENESIS/man/GENESIS.pdf
  label: Documentation
sbg:modifiedBy: dave
sbg:modifiedOn: 1620320282
sbg:original_source: dave/build-instance-specific-casual-inference/vcf-to-gds/1
...
sbg:revisionsInfo:
- sbg:modifiedBy: dave
  sbg:modifiedOn: 1620320192
  sbg:revision: 0
  sbg:revisionNotes: Copy of admin/sbg-public-data/vcf-to-gds/15
- sbg:modifiedBy: dave
  sbg:modifiedOn: 1620320282
  sbg:revision: 1
  sbg:revisionNotes: ''
